        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return helper_helper.btncancel(event, _this.options);

              case 2:
                helper_helper.clickMaskCloseAll(event, _this.options.layer, _this.options.id);
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              if (_this2.options.shade) {
                //是否显示遮罩
                document.getElementById(_this2.options.id + "_mask").addEventListener("mousemove", function (event) {
                  _this2.move(event);
                });
                document.getElementById(_this2.options.id + "_mask").addEventListener("mouseup", function (event) {
                  _this2.moveEnd(event);
                });
              } else {
                document.addEventListener("mousemove", function (event) {
                  _this2.move(event);
